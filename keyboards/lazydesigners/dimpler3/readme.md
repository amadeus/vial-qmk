...
A gasket mounted 40% keyboard designed and produced in 2025 by [LAZYDESIGNERS](http://lazydesigners.cn).
Dimple R1 and R2 are not compatible with the new Dimple R3 PCB design.

* Keyboard Maintainer: [LAZYDESIGNERS](https://github.com/jackytrabbit)
* Hardware Supported: Dimple R3
